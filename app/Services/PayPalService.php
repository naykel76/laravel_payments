...
class PayPalService
{
    ...
    // added currency, refactor request for order details???
    public function handlePayment(Request $request, $currency = 'AUD')
    {
        $order = $this->createOrder($request->value, $currency);
